...
const Footer = () => {
  const footerLinks = {
    Product: ['Real-Time CDP', 'InfinityAI', 'Omnichannel', 'Gamification', 'Analytics'],
    Solutions: ['iGaming', 'Lottery', 'Retail', 'Finance', 'Travel'],
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">CDPiGaming</span>
            </div>
            <p className="text-gray-400 text-sm mb-6">
              CRM & Loyalty Marketing powered by InfinityAI
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <div>
            © {new Date().getFullYear()} CDPiGaming. All rights reserved.
          </div>
